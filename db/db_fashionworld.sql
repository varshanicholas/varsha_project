...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 24, 2024 at 10:13 AM
...
INSERT INTO `form` (`cust_id`, `Proname`, `Proprice`, `Type`, `Discount`, `Color`, `Image`) VALUES
(44, 'plazzo', '2000', 'Cotton fabric', '50%', 'red', 'g8.JPG'),
(45, 'Bridal gown', '30000', 'semi-cotton', '20%', 'white', 'g4.JPG'),
(46, 'kurthi', '30000', 'cotton', '12%', 'red', 'g4.JPG'),
(47, 'kurthi', '0999', 'cotton', '12', 'red', 'g1.webp'),
(48, 'gown', '30000', 'silk cotton', '20%', 'white', 'g12.jpg'),
(49, 'gown', '600', 'silk cotton', '10%', 'white', 'g5.jpg'),
(53, 'kurthi', '400', 'silk', '20%', 'red', 'Screenshot 2023-09-09 144121.png');

-- --------------------------------------------------------

--
-- Table structure for table `oodered_product`
--

CREATE TABLE `oodered_product` (
  `od_id` int(200) NOT NULL,
...
--
-- Dumping data for table `oodered_product`
--

INSERT INTO `oodered_product` (`od_id`, `pro_name`, `product_type`, `pro_price`, `discount`, `quantity`, `total`, `status`, `user_id`) VALUES
(10, 'plazzo', 'Cotton fabric', '2000', '50%', '4', '8000.00', 2, ''),
(11, 'kurthi', 'cotton', '0999', '12', '4', '3996.00', 2, ''),
(12, 'gown', 'silk cotton', '600', '10%', '2', '1200.00', 1, ''),
(13, 'gown', 'silk cotton', '600', '10%', '1', '600.00', 1, ''),
(14, 'plazzo', 'Cotton fabric', '2000', '50%', '2', '4000.00', 1, ''),
(16, 'plazzo', 'Cotton fabric', '2000', '50%', '5', '10000.00', 1, ''),
(17, 'Bridal gown', 'semi-cotton', '30000', '20%', '10', '300000.00', 2, ''),
(18, '$name', '$type', '$price', '$discount', '$quantity', '$total', 0, '$user_id'),
(19, 'plazzo', 'Cotton fabric', '2000', '50%', '5', '10000.00', 0, '12'),
(20, 'Bridal gown', 'semi-cotton', '30000', '20%', '2', '60000.00', 0, '13');
...
INSERT INTO `register` (`reg_id`, `cust_name`, `email`, `password`, `Address`, `country`, `state`) VALUES
(11, 'varsha', 'varshanicholas14@gmail.com', '1234', 'kollemcode kanyakumari', '95', '1613'),
(12, 'dhivya', 'dhivya@gmail.com', '1234', 'kollemcode', '9', '206'),
(13, 'Varsha N', 'varshanicholas14@gmail.com', '0987', 'kollemcode kanyakumari', '101', '29'),
(14, 'hgby', 'hgby@gmail.com', '667889', 'rgfvsnji', '101', '12'),
(15, 'jibi', 'varshhhh@gmail.com', '9806', 'rgfvsnji', '101', '8');
...
--
-- Indexes for table `oodered_product`
--
ALTER TABLE `oodered_product`
...
--
-- AUTO_INCREMENT for table `oodered_product`
--
ALTER TABLE `oodered_product`
  MODIFY `od_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
