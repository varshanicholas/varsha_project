...
<div class="wthree_agile_admin_info">
    ...
    $res = $con->query("SELECT * FROM `oodered_product`");
    $count = $res->num_rows;
    ?>
    <div class="agile-tables">
        <div class="w3l-table-info agile_info_shadow">
            <h3 class="w3_inner_tittle two">Odered products Details</h3>
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <a href="oder_tab_approved.php ? var=<?php echo $row["od_id"];?> " class= "btn btn-success"> Approved </a>
								<a href="oder_tab_reject.php ? reg=<?php echo $row["od_id"];?>" class= "btn btn-danger"> Rejuct </a>
