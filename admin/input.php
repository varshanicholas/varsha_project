													...
													<div class="forms-main_agileits">
															...
															<div class="graph-form agile_info_shadow">
															 <h3 class="w3_inner_tittle two">Basic Form </h3>
																	<div class="form-body">
																		<form action= "form_conne.php" method="post" enctype ="Multipart/form-data" >
																			 <div class="form-group">
																				 <label for="productname">Product Name</label>
																				  <input type="text" name="a" class="form-control" id="productname">
																				 </div>
																				  <div class="form-group"> 
																					<label for="pricedetail">Product price</label> 
																					<input type="text" name="b" class="form-control" id="price">
																				 </div> 
																				 
																				 <div class="form-group"> 
																					<label for="productypes">Product type</label> 
																					<input type="text" name="c" class="form-control" id="type">
																				 </div> 
																				 <div class="form-group"> 
																					<label for="diss">Discount</label> 
																					<input type="text" name="d" class="form-control" id="discountdetails">
																				 </div> 
																				 <div class="form-group"> 
																					<label for="color">Available colors</label> 
																					<input type="text" name="e" class="form-control" id="color">
