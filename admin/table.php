								...
								<li>
									...
									<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="input.php"><i class="fa fa-caret-right" aria-hidden="true"></i>Add Products</a></li>
								     	...
								     	<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="reg_table.php"> <i class="fa fa-caret-right" aria-hidden="true"></i>User Registraion</a></li>
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td><img src="<?php echo "pic/". $row["Image"]; ?>" alt="Product Image" style="width: 100px;"></td>
								<td><a href="edit.php ? var=<?php echo $row["cust_id"];?>" class= "btn btn-success"> Edit </a></td>
								<td><a href=" delete.php? del=<?php echo $row["cust_id"];?>" Onclick= "if (!confirm('Are you sure?')) { return false }" class= "btn btn-danger">Delete</a></td>
