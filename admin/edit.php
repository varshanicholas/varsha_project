					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller scrollbar1">
							<ul class="gn-menu agile_menu_drop">
								...
								<li>
									<a href="input.php"><i class="fa fa-cogs" aria-hidden="true"></i> PRODUCT DETAILS <i class="fa fa-angle-down" aria-hidden="true"></i></a> 
									<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="Oders_table.php"><i class="fa fa-caret-right" aria-hidden="true"></i>VIEW ORDERS</a></li>
								...
								<li>
									...
									<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="input.php"><i class="fa fa-caret-right" aria-hidden="true"></i>Add Products</a></li>
								     	...
								     	<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="reg_table.php"><i class="fa fa-caret-right" aria-hidden="true"></i>USER REGISTR<li class="mini_list_w3"><a href="icons.html"> <i class="fa fa-caret-right" aria-hidden="true"></i> Icons</a></li>
															 ...
															 <h3 class="w3_inner_tittle two">Basic Form </h3>
																	<div class="form-body">
																		<form action= "update.php" method="post" enctype ="Multipart/form-data" >
                                                                            <input type= "hidden" name="cusid" value= "<?php echo $row["cust_id"];?>">
																			 <div class="form-group">
																				 <label for="productname">Product Name</label>
																				  <input type="text" name="a" class="form-control" value="<?php echo $row["Proname"];?>" id="productname">
																				 </div>
																				  <div class="form-group"> 
																					<label for="pricedetail">Product price</label> 
																					<input type="text" name="b" class="form-control"value="<?php echo $row["Proprice"];?>" id="price">
																				 </div> 
																				 
																				 <div class="form-group"> 
																					<label for="productypes">Product type</label> 
																					<input type="text" name="c" class="form-control" value="<?php echo $row["Type"];?>" id="type">
																				 </div> 
																				 <div class="form-group"> 
																					<label for="diss">Discount</label> 
																					<input type="text" name="d" class="form-control" value="<?php echo $row["Discount"];?>" id="discountdetails">
																				 </div> 
																				 <div class="form-group"> 
																					<label for="color">Available colors</label> 
																					<input type="text" name="e" class="form-control" value="<?php echo $row["Color"];?>" id="color">
																					
																				 </div> 
																				 <div class="form-group"> 
																					<label for="uploadproduct">product image</label>
																					 <input type="file" name="image" class="form-control" value="<?php echo $row["Image"];?>" id="exampleInputFile">
                                                                                     <img src="<?php echo "pic/". $row["Image"]; ?>" alt="Product Image" width=100px;></td>
																					 </div>
																					  <div class="checkbox">
