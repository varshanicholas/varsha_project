...
<div class="wthree_agile_admin_info">
    ...
    <div class="agile-tables">
        <div class="w3l-table-info agile_info_shadow">
            <h3 class="w3_inner_tittle two">User Registration Details</h3>
            <table id="table">
                <thead>
                    <tr>
					    <th>no</th>
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td><a href="../reg_edit.php? var=<?php echo $row["reg_id"];?>" class= "btn btn-success"> Edit </a></td>
								<td><a href=" reg_delete.php? del=<?php echo $row["reg_id"];?>" Onclick= "if (!confirm('Are you sure?')) { return false }" class= "btn btn-danger">Delete</a></td>
